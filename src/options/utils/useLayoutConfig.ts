...
export function useLayoutConfig() {
  ...
  const loadConfig = async () => {
    console.log('useLayoutConfig: Loading layout configuration...');
    try {
      ...
      console.log('useLayoutConfig: Layout config loaded successfully, tabs count:', layoutConfig.tabs.length);
    } catch (error) {
  ...
  const saveConfig = async () => {
    try {
      console.log('useLayoutConfig: Saving layout config...');
      ...
      if (success) {
        // 保存成功后重置变更标记
        hasUnsavedChanges.value = false;
        console.log('useLayoutConfig: Layout config saved successfully');
      }
  ...
  const resetToDefault = () => {
    console.log('useLayoutConfig: Resetting to default layout config');
    ...
    console.log('useLayoutConfig: Reset to default config completed');
  };
