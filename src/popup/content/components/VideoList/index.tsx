...
export default defineComponent({
    ...
    setup() {
        ...
        const onPlay = (data: any) => {
            if (data.id === playingUrl.value && qrUrl.value === '' && player.value?.destroy) {
                    ...
                    videoList.value.map((v: any) => (
                        ...
                        >
                            <div class="video-info">
                                <div class="video-info-box">
                                    <div class="video-info-name">
                                        {v.title || rollConfig.document?.title || v.url}</div>
                                </div>
                            ...
                            <div class="extra-info">
                                {
                                    playingUrl.value === v.id ? <video id="video-player" playsinline controls autoplay></video> : null
                                }
                                {
